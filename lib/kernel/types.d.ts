...
export type FailureKind = 'timeout' | 'cancelled' | 'unavailable' | 'schema' | 'budget' | 'circuit-open';
...
export type SkipReason = 'permanent-failure' | 'cooldown' | 'consecutive-limit' | 'paused' | 'session-paused' | 'pending-approval' | 'circuit-open' | 'no-agent' | 'unavailable';
...
export declare const AUDIT_EVENTS: readonly ['ap/state', 'ap/resumed', 'ap/skipped', 'ap/loop', 'ap/decision', 'ap/grant', 'ap/verdict', 'ap/circuit', 'ap/override'];
 ...
 */
export declare const VISIBLE_AUDIT_EVENTS: readonly AuditEventName[];
