...
- 独立包名 `dsh-autopilot`（α 改名卡 TC-B3-33D，治理 id `core/autopilot`），行 id `autopilot`；宿主包 devDeps 钉 `0.1.2-rc.1`（registry 离 zDSH 0.1.3-alpha.1 基线最近的可复现快照），peer `>=0.1.0-rc.2` optional。
